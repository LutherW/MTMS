    ...
    <div class="l-list">
      ...
      <div class="menu-list">
        <div class="rule-single-select">
          <asp:DropDownList ID="ddlTypeName" runat="server" AutoPostBack="True" onselectedindexchanged="ddlTypeName_SelectedIndexChanged"></asp:DropDownList>
        </div>
        <div class="rule-single-select">
...
<ItemTemplate>
  <tr>
    ...
    <td width="64">
      <a href="customer_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("Id")%>">
        <%#Eval("ShortName")%>
      </a>
    </td>
    <td><%#Eval("FullName")%></td>
    ...
    <td align="center"><%#Eval("MobileNumber")%></td>
    <td align="center"><%#Eval("TaxRegistrationNumber")%></td>
    <td align="center"><%#Eval("Remarks")%></td>
    <td align="center"><a href="customer_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("Id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
